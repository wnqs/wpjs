...
window.renderHome = function () {
    const navItems = [
        { icon: '🚗',  name: '车辆数据',     desc: '全车辆图鉴与属性',   route: 'vehicles' },
        { icon: '⚖️',  name: '平衡性调整',   desc: '版本更新调整记录',   route: 'balance' },
        { icon: '💠',  name: '芯片系统',     desc: '芯片图鉴与搭配',     route: 'chips' },
        { icon: '🔮',  name: '赋能系统',     desc: '赋能模块与推荐',     route: 'empower' },
        { icon: '📦',  name: '资源获取',     desc: '全资源获取途径',     route: 'resources' },
        { icon: '🖼️',  name: '静态壁纸',     desc: '精美壁纸收藏',       route: 'wallpaper-static' },
        { icon: '🎬',  name: '动态壁纸',     desc: '动态壁纸展示',       route: 'wallpaper-live' },
        { icon: '🎥',  name: 'CG',          desc: '游戏CG动画',         route: 'cg' },
        { icon: '📺',  name: 'PV',          desc: '宣传视频合集',       route: 'pv' },
    ];
